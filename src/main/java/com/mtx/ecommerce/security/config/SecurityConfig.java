...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.
                ...
                .disable()
                .authorizeRequests()
                .antMatchers(Endpoints.REGISTER_PATH).permitAll()
                .antMatchers(Endpoints.LOGIN_PATH).permitAll()
                .antMatchers(HttpMethod.GET, Endpoints.BRAND).permitAll()
                .antMatchers(HttpMethod.GET, Endpoints.CATEGORY).permitAll()
                .antMatchers(HttpMethod.GET, Endpoints.PRODUCT).permitAll()
                .antMatchers(HttpMethod.GET, Endpoints.SLIDE).permitAll()
                ...
                .antMatchers(HttpMethod.POST, Endpoints.SLIDE).hasAnyAuthority(ADMIN, SELLER)
                ...
                .antMatchers(HttpMethod.PATCH, Endpoints.SLIDE).hasAnyAuthority(ADMIN, SELLER)
                ...
                .antMatchers(HttpMethod.DELETE, Endpoints.SLIDE).hasAnyAuthority(ADMIN, SELLER)
                .anyRequest()
                .authenticated()
                .and()
                .exceptionHandling()
